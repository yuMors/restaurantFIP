...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public List<UserMenuDTO> listUserMenus() {
        ...
        System.out.println("UserUtil.getUserDetailsDTO().getId(): "+UserUtil.getUserDetailsDTO().getId());
        System.out.println("UserUtil.getUserDetailsDTO().getUserInfoId(): "+UserUtil.getUserDetailsDTO().getUserInfoId());
        System.out.println("UserUtil.getUserDetailsDTO().getUsername(): "+UserUtil.getUserDetailsDTO().getUsername());
        System.out.println("这里是用户菜单 userInfoId: "+userInfoId);
        //List<Menu> menus = menuMapper.listMenusByUserInfoId(userInfoId);
        Integer role = menuMapper.getRoleId(userInfoId);
        List<Integer> roleMenu = menuMapper.getRoleMenu(role);
        List<Menu> menus = menuMapper.selectBatchIds(roleMenu).stream().distinct().collect(Collectors.toList());
