...
<!--      <el-table-column prop="commentContent" label="评论内容" align="center" show-tooltip-when-overflow>-->
...
<!--      </el-table-column>-->
      <el-table-column label="操作" width="160" align="center">
        <template slot-scope="scope">
          ...
          <el-popconfirm style="margin-left: 10px" cancel-button-type="" title="确定删除吗？" @confirm="deleteComments(scope.row.id)">
