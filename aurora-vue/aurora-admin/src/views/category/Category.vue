...
<!--      <el-table-column prop="articleCount" label="餐厅量" align="center"/>-->
      ...
      <el-table-column label="操作" width="160" align="center">
        <template slot-scope="scope">
          ...
          <el-popconfirm title="确定删除吗？" style="margin-left: 1rem" cancel-button-type="" @confirm="deleteCategory(scope.row.id)">
