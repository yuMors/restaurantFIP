<template>
  <el-card class="main-card">
    ...
    <div class="operation-container">
      ...
      <el-button type="danger" size="small" icon="el-icon-delete" :disabled="this.roleIds.length == 0"
        @click="isDelete = true">
        批量删除
      </el-button>
      <div style="margin-left: auto">
        <el-input v-model="keywords" prefix-icon="el-icon-search" size="small" placeholder="请输入角色名" style="width: 200px"
    ...
    <el-table border :data="roles" @selection-change="selectionChange" v-loading="loading">
      ...
      <el-table-column label="操作" align="center" width="220">
        <template slot-scope="scope">
          ...
          <el-popconfirm title="确定删除吗？" style="margin-left: 10px" cancel-button-type="" @confirm="deleteRoles(scope.row.id)">
    ...
    <el-dialog :visible.sync="roleResource" width="30%" top="9vh">
      ...
      <el-form label-width="80px" size="medium" :model="roleForm">
        ...
        <el-form-item label="资源权限">
          <el-tree :data="resources" :default-checked-keys="roleForm.resourceIds" show-checkbox node-key="id"
            ref="resourceTree" />
        </el-form-item>
      </el-form>
      <div slot="footer">
  ...
  methods: {
    ...
    openMenuModel(role) {
      this.$nextTick(function () {
        console.log('this.$refs.menuTree22-',this.$refs)
        this.$refs.menuTree.setCheckedKeys([])
        // this.$refs.menuTree.setCheckedKeys(null) setCheckedKeys
      })
