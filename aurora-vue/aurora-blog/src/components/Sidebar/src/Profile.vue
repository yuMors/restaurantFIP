    ...
    <div
      ...
      <div class="profile absolute w-full flex flex-col justify-center items-center">
        <div class="flex flex-col justify-center items-center">
          ...
          <img v-else :class="avatarClass" :src="defaultImg" />
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      defaultImg: 'http://rs81ljuv5.hb-bkt.clouddn.com/2023/03/28/20230328-170921YH-d73d57c2a22ef2.png',
