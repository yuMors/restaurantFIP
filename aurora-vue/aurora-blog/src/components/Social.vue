...
<!--    <a :href="websiteConfig.github" target="_blank" ref="github" v-if="websiteConfig.github">-->
    <a href="https://top.baidu.com/board?platform=pc" target="_blank" ref="https://www.baidu.com/" v-if="websiteConfig.github">
      <li class="diamond-clip-path diamond-icon">
        <svg-icon icon-class="hot" class="fill-current" />
      </li>
    </a>
<!--    <a :href="websiteConfig.gitee" target="_blank" ref="github" v-if="websiteConfig.gitee">-->
    <a href="https://limestart.cn/" target="_blank" ref="github" v-if="websiteConfig.gitee">
      <li class="diamond-clip-path diamond-icon">
        <svg-icon icon-class="toc" class="fill-current" />
      </li>
    </a>
...
export default defineComponent({
  ...
  created() {
    console.log('-----')
    console.log('aaaaa',this.websiteConfig.github)
    console.log('aaaaa',this.websiteConfig.gitee)
    console.log('aaaaa',this.websiteConfig)
  }
})
</script>
