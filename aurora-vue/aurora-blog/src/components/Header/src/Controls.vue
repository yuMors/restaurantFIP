...
<!--      搜索-->
<!--    </el-button>-->
<!--  <Dropdown v-if="multiLanguage === 1" @command="handleClick"> &lt;!&ndash;  这里直接写死 中文&ndash;&gt;-->
<!--    <Dropdown v-if="1 === 1">-->
        ...
        <span class="mr-2" >用户:&nbsp;&nbsp;
          <div class="flex-shrink-0">
            <div class="rounded-full ring-gray-100 overflow-hidden shaodw-lg w-9" >
              <img class="avatar-img" :src="userInfo.avatar" alt="" slot="error"/>
            </div>
          </div>
        </span>
        <DropdownMenu>
...
<!--      </el-form-item>-->
  ...
  <el-dialog v-model="articlePasswordDialogVisible" width="30%" :fullscreen="isMobile">
    <el-form @submit.native.prevent @keyup.enter.native="accessArticle">
      <el-form-item model="userInfo" class="mt-5">
        <el-input id="article-password-input" v-model="articlePassword" placeholder="受密码保护,请输入密码" />
      </el-form-item>
      <el-form-item>
  ...
  setup() {
    ...
    return {
      ...
      multiLanguage: computed(() => {
        ...
        console.log('websiteConfig.multiLanguage',websiteConfig.multiLanguage)
